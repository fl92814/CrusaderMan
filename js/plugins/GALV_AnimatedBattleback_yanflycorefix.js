...
Spriteset_Battle.prototype.setAnimatedBattlebacks = function() {
	if (this.bb1anim) {
		...
		this._back1Sprite.update = Sprite_Battleback.prototype.updateAnimBattleback;
	...
	if (this.bb2anim) {
		...
		this._back2Sprite.update = Sprite_Battleback.prototype.updateAnimBattleback;
		this._back2Sprite.x = 0;
	};
};

Sprite_Battleback.prototype.updateAnimBattleback = function() {
	Sprite_Battleback.prototype.update.call(this);
	if (this._aTicker <= 0) {
		this._aFrame = this._aFrame === this._aFrames - 1 ? 0 : this._aFrame + 1;
		// console.log(this);
		this.x = (this._aFrame * (this._realFrame.width / this._aFrames)) - (this._realFrame.width / 2) + (this._realFrame.width / this._aFrames);
		// console.log(this._aFrame + ' : ' + this.x);
